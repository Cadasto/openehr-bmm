 ...
 */
readonly class BmmEnumerationInteger extends AbstractBmmClass
{
    /**
     * @param string $name
     ...
     * @param array<integer> $itemValues
    ...
    /**
     * Create a BmmEnumerationInteger from an array representation
     *
