...
This project does not commit `composer.lock` (library); CI uses `composer install` without lock for broader compatibility.

## Security reporting

Do **not** disclose vulnerabilities publicly.

Report them privately to the team (e.g. via the security contact set in SECURITY.md, such as `security@cadasto.com`). Include reproduction steps and impact assessment.
